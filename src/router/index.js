...
const routes = [
	...
	},
	{
		...
		name: 'NoPageFound',
		component: () =>
			import(/* webpackChunkName: "projects" */ '../views/NoPageFound.vue'),
		meta: {
			title: 'LeoNavarro - NopageFound',
		},
	},
];
